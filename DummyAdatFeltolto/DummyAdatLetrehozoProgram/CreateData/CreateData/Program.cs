...
namespace CreateData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            StreamWriter login = new StreamWriter(@"sqlfiles\login.sql",append:true);
            StreamWriter utas = new StreamWriter(@"sqlfiles\utas.sql", append:true);
            StreamWriter dolgozo = new StreamWriter(@"sqlfiles\dolgozo.sql", append:true);
            StreamWriter varosiro = new StreamWriter(@"sqlfiles\varosok.sql", append:true);
            StreamWriter vonatok = new StreamWriter(@"sqlfiles\vonatok.sql", append:true);
            StreamWriter rendezveny = new StreamWriter(@"sqlfiles\rendezveny.sql", append:true);
            StreamWriter jegyiro = new StreamWriter(@"sqlfiles\jegy.sql", append:true);
            StreamWriter beosztas = new StreamWriter(@"sqlfiles\beosztas.sql", append:true);
            StreamWriter eladottjegyek = new StreamWriter(@"sqlfiles\eladottjegyek.sql", append:true);
